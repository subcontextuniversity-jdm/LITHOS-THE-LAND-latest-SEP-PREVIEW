...
Josh's mixed-engine browser shortlist (Wavebox / Firefox / Floorp, not three Chromium shells) lives in [research/josh-browser-operating-surface.md](research/josh-browser-operating-surface.md).
